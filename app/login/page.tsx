      ...
      <div className="hidden md:flex md:w-[45%] bg-cobalt p-12 flex-col justify-between relative overflow-hidden text-paper">
          <div className="z-10 relative">
            <Link href="/" className="inline-block">
              <Logo className="h-8 w-auto filter invert brightness-0" />
            </Link>
          </div>
          <div className="z-10 relative mt-auto mb-16">
            <h2 className="text-4xl font-bold tracking-tight mb-4 leading-tight">
              Welcome back to<br />your analytics.
            </h2>
            <p className="text-paper/70 text-lg">
              Log in to see how your links are performing in real-time.
            </p>
          </div>
        ...
        <div className="w-full md:w-[55%] p-8 sm:p-12 flex flex-col justify-center">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block text-sm font-medium text-ink/70 mb-2">Your email</label>
              <input
                name="email"
                type="email"
            ...
            <div className="text-center pt-4">
              ...
              <Link href="/signup" className="text-sm font-bold text-ink hover:underline underline-offset-4">
                Sign up
              </Link>
            </div>
          </form>
