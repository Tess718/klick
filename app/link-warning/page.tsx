...
export const metadata: Metadata = {
  ...
  description: "The link you are trying to visit has been flagged as potentially unsafe by Google Safe Browsing.",
};
...
export default async function LinkWarningPage({
  searchParams,
}: {
      ...
      <Card className="max-w-md w-full border-red-500/30 shadow-2xl backdrop-blur-xl relative z-10 overflow-hidden">
        ...
        <CardHeader className="text-center pt-8 pb-4">
          ...
          <CardDescription className="text-muted-foreground text-sm mt-1">
            Google Safe Browsing flagged this destination as potentially dangerous.
          </CardDescription>
        </CardHeader>
